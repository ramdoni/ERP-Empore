                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="pesawat">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <label style="font-weight: normal;">
                                            <input type="radio" readonly="true" {{ $data->pesawat_perjalanan == 'Sekali Jalan' ? 'checked' : '' }} name="pesawat_perjalanan" value="Sekali Jalan"> Sekali Jalan
                                        </label> &nbsp;&nbsp;
                                        <label style="font-weight: normal;">
                                            <input type="radio" readonly="true" {{ $data->pesawat_perjalanan == 'Pulang Pergi' ? 'checked' : '' }} name="pesawat_perjalanan" value="Pulang Pergi"> Pulang Pergi
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" placeholder="Tanggal Berangkat" value="{{ $data->tanggal_berangkat }}" name="tanggal_berangkat" readonly class="form-control">
                                    </div>
                                    ...
                                    <div style="float: left; width: 5px;padding-top:10px;"> - </div>
                                    <div class="col-md-2"><input type="text" placeholder="Tanggal Pulang" name="tanggal_pulang" class="form-control" readonly value="{{ $data->tanggal_pulang }}">
                                    </div>
                                    <div style="float: left; width: 5px;padding-top:10px;"> / </div>
                                    <div class="col-md-1">
