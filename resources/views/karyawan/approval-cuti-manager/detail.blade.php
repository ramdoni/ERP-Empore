...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-cuti" enctype="multipart/form-data" action="{{ route('karyawan.approval.cuti-manager.proses') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="noted" style="height:100px;" class="form-control" value="{{ $data->catatan_manager }}">
                                </div>
                            </div>
                        ...
                        <br />
                        <div class="col-md-12">
                            <a href="{{ route('karyawan.approval.cuti-manager.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>
                            @if($data->is_approved_manager ==NULL and $data->status < 3)
