                    ...
                    <div class="white-box">
                        ...
                        <div class="col-md-6" style="padding-left: 0;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text"  name="noted" style="height:100px;" class="form-control" value="{{ $data->approve_direktur_noted }}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            @if($data->is_approved_atasan ==1 and $data->is_approved_manager ==1 and $data->approve_direktur === NULL and $data->status < 3)
