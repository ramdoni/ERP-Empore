                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="kegiatan">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label class="col-md-6 select-cabang" style="{{ $data->jenis_training != 'Branch Visit' ? 'display:none' : ''  }}">Lokasi Cabang</label>
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="pesawat">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-2"><input type="text" placeholder="Tanggal Pulang" name="tanggal_pulang" class="form-control datepicker" readonly value="{{ $data->tanggal_pulang }}">
                                        </div>
                                        <div style="float: left; width: 5px;padding-top:10px;"> / </div>
                                         <div class="col-md-1">
