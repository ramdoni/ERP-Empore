                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td>Taxi</td>
                                    <td><input placeholder="Rp" type="number" {{$readonly}} class="form-control calculate_1" name="transportasi_taxi" value="{{ $data->transportasi_taxi }}" ></td>
                                ...
                                <tr>
                                    ...
                                    <td><input placeholder="Rp" type="number" class="form-control" readonly="true" value="{{ $data->transportasi_tol_disetujui }}"></td>
                                    <td>
                                        <div class="col-md-6">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                             <tr>
                                ...
                                @else
                                    <tr>
                                        <td colspan="8"><i>Tidak ada plafond ...</i></td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
                    ...
                    <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" readonly="true" class="form-control" value="{{ $data->uang_biaya_lainnya1_nominal_disetujui }}" {{$readonly}}  placeholder="Rp. " />
                                </td>
                                <td>
                                    <div class="col-md-6">
                                ...
                                <td>
                                    <input type="text" readonly="true" class="form-control" value="{{ $data->uang_biaya_lainnya1_catatan }}" placeholder="Catatan" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                ...
                                <td>
                                    <input type="text" readonly="true" value="{{ $data->uang_biaya_lainnya2_catatan }}" class="form-control" placeholder="Catatan" />
                                </td>
                            </tr>
                            <tr>
