                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="kegiatan">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12" style="border: 1px solid #eee; padding: 15px">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control autcomplete-atasan" placeholder="Select Superior">
                                    ...
                                    <div class="col-md-12" style="border: 1px solid #eee; padding: 15px">
                                     <div class="form-group">
                                            <div class="col-md-12">
                                                <input type="text" class="form-control autcomplete-manager" placeholder="Select Manager">
                                                <input type="hidden" name="approved_manager_id" />
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $(".autcomplete-manager" ).autocomplete({
        ...
        minLength:0, 
        select: function( event, ui ) {
            $( "input[name='approved_manager_id']" ).val(ui.item.id);
