                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade in active" id="kegiatan">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="tanggal_kegiatan_start" id="from" required class="form-control" placeholder="Dari Tanggal">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" name="tanggal_kegiatan_end" id="to" required class="form-control" placeholder="Sampai Tanggal">
                                        </div>
                                    </div>
                                    <hr />
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="pesawat">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <input type="text" placeholder="Tanggal Berangkat" id="from_tanggal_berangkat" name="tanggal_berangkat" class="form-control">
                                    </div>
                                    ...
                                    <div class="col-md-2"><input type="text" readonly="true" placeholder="Tanggal Pulang" id="to_tanggal_pulang" name="tanggal_pulang" class="form-control">
                                    </div>
                                    <div style="float: left; width: 5px;padding-top:10px;"> / </div>
                                     <div class="col-md-1">
                                        <input type="text" class="form-control time_picker" readonly="true"  placeholder="Waktu" name="waktu_pulang" />
                                    </div>
                                </div>
                                <div class="form-group">
