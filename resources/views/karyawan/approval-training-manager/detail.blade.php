...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-training" enctype="multipart/form-data" action="{{ route('karyawan.approval.training-manager.proses') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            -->
                                            <select class="form-control" readonly name="training_type_id">
                                                <option value=""> - choose - </option>
                                                @foreach($trainingtype as $item)
                                                <option value="{{ $item->id }}" {{ $item->id== $data->training_type_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                @endforeach
                                            </select>
                        ...
                        <div class="col-md-12">
                            ...
                            @if($data->is_approved_manager == 0 and $data->status <3)
...
<script type="text/javascript">
    ...
    $("#btn_approved").click(function(){
        bootbox.confirm('Approve Employee Business Trip ?', function(result){
    ...
    $("#btn_tolak").click(function(){
        bootbox.confirm('Reject Employee Business Trip ?', function(result){
