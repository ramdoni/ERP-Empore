...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <!-- .row -->
        <div class="row">
            <form class="form-horizontal" id="form-actual-bill" enctype="multipart/form-data" action="{{ route('karyawan.approval.training-manager.proses-biaya') }}" method="POST">
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <?php 
                            $readonly = "";
                            if($data->is_approve_manager_actual_bill == 1 || $data->is_approve_manager_actual_bill === 0)
                            {
                      ...
                      <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                    ...
                                    <tr >
                                    <th colspan="2" class="text-left" style="font-size: 12px;">TSub otal Daily & Meal Allowance Approved : </th>
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="col-md-12" style="padding-left: 0;">
                            <a href="{{ route('karyawan.approval.training-manager.index') }}" class="btn btn-sm btn-default waves-effect waves-light m-r-10"><i class="fa fa-arrow-left"></i> Back</a>

                            @if($data->is_approve_manager_actual_bill === NULL)
...
<script type="text/javascript">
    ...
    var calculate_allAllowance  = function(){
       ...
       // alert("morning" + totalMorning + "Afternoon" + totalAfternoon + "evening" + totalEvening + "Daily" + totalDaily);
