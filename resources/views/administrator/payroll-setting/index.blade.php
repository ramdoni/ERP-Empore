                                ...
                                <table id="data_table_no_copy" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('administrator.payroll-setting.delete-pph', $item->id) }}" onclick="return confirm('Hapus data ini ?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                    ...
                                    <tbody>
                                       @foreach($others as $no => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('administrator.payroll-setting.delete-others', $item->id) }}" onclick="return confirm('Hapus data ini?')" class="btn btn-danger btn-xs "><i class="fa fa-trash"></i> </a>
